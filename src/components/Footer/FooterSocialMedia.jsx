            ...
            <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
                ...
                <li className="ms-3">
                    <a className="text-body-secondary" href="https://www.facebook.com">
                        <svg xmlns="http://www.w3.org/2000/svg" className=" socialNetwork bi bi-facebook me-3"  fill="currentColor" viewBox="0 0 16 16">
                ...
                <li className="ms-3">
                    <a className="text-body-secondary" href="https://www.instagram.com">
                        <svg xmlns="http://www.w3.org/2000/svg"className="socialNetwork bi bi-instagram me-3"  fill="currentColor"  viewBox="0 0 16 16">
                ...
                <li className="ms-3">
                    <a className="text-body-secondary" href="https://x.com/?lang=es">
                        <svg xmlns="http://www.w3.org/2000/svg" className="socialNetwork  bi bi-twitter-x me-5"  fill="currentColor" viewBox="0 0 16 16">
